...
(function () {
  const messages = {
    ...
    'zh-CN': {
      ...
      routingRouteTo: '路由到',
      routingCondModel: 'Model ==',
      routingCondModelMatches: '模型名匹配（正则）',
      routingCondLength: 'Prompt length >',
      routingCondRegex: 'Prompt matches',
      routingPlaceholderModel: '模型名称',
      routingPlaceholderModelMatches: '仅匹配 model 字段，例如 ^gpt-4',
